...
export default function Hero() {
  ...
  return (
    ...
    >
      <BubbleBackground
        interactive={true}
        className="min-h-screen flex items-center justify-center w-full pt-16 bg-slate-50 dark:bg-dark"
        colors={{
          first: "59,130,246",
          second: "16,185,129",
          third: "59,130,246",
      ...
      >
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse md:flex-row items-center gap-10 z-10">
          {/* Text */}
